...
const SAMPLE_PRODUCTS = [
  ...
  },
  {
    ...
    name: '프리미엄 플라워 원피스',
    slug: 'women-dress',
    description: '우아한 플라워 패턴이 돋보이는 여성 원피스입니다. 부드러운 실크 혼방 소재로 편안한 착용감과 고급스러운 실루엣을 동시에 느낄 수 있습니다. 데일리룩부터 특별한 날까지 다양하게 활용 가능합니다.',
    price: 79000,
    comparePrice: 129000,
    stock: 85,
    sku: 'DRESS-001',
    images: [
      ...
      'https://images.unsplash.com/photo-1549127319-c2e6c2f630bc?w=800',
    ],
    thumbnail: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=400',
    category: { name: '패션의류', slug: 'fashion' },
    features: [
      '프리미엄 실크 혼방 소재',
      '스트레치 원단으로 편안한 착용감',
      '세련된 플라워 패턴',
    ...
    specs: [
      { label: '소재', value: '폴리에스터 70%, 실크 20%, 스판덱스 10%' },
      { label: '사이즈', value: 'S / M / L / XL' },
      { label: '색상', value: '화이트 플라워, 핑크 플라워, 블루 플라워' },
      { label: '기장', value: 'S: 107cm, M: 109cm, L: 111cm, XL: 113cm' },
      { label: '세탁방법', value: '울코스 세탁 또는 드라이클리닝 권장' },
      { label: '제조국', value: '한국' },
    ],
    reviews: [
      {
        ...
        userName: '김소희',
        rating: 5,
        comment: '원피스 핏이 너무 예뻐요! 실크 혼방이라 입었을 때 느낌이 고급스럽습니다. 사이즈도 정확해요.',
        date: '2026-02-17',
        helpful: 45,
      },
      {
        ...
        userName: '박지은',
        rating: 5,
        comment: '색감이 화면보다 더 예뻐요. 플라워 패턴이 화려하지 않고 은은해서 좋습니다.',
        date: '2026-02-16',
        helpful: 38,
      },
      {
        ...
        userName: '이민주',
        rating: 4,
        comment: '원단이 부드럽고 착용감이 편해요. 다만 조금 비침이 있어서 속치마 필요할 것 같아요.',
        date: '2026-02-15',
        helpful: 29,
      },
      {
        ...
        userName: '최유진',
        rating: 5,
        comment: 'A라인 디자인이라 체형 커버도 되고 우아해 보여요. 사무실 출근용으로 딱!',
        date: '2026-02-14',
        helpful: 52,
      },
      {
        ...
        userName: '정은서',
        rating: 4,
        comment: '세탁 후에도 형태가 잘 유지돼요. 가성비 좋은 원피스입니다.',
        date: '2026-02-12',
        helpful: 34,
      },
      {
        ...
        userName: '강혜진',
        rating: 5,
        comment: '데이트, 출근, 모임 등 어디든 입기 좋아요. 완전 만족합니다!',
        date: '2026-02-10',
        helpful: 41,
      },
    ],
